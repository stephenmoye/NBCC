	...
	$.fn[ pluginName ] = function(){
		...
		return this.each(function(){
			...
			// if the nextprev option is set, add the nextprev nav
				var	$nextprev = $( '<ul class="snapper_nextprev"><li class="snapper_nextprev_item"><a href="#prev" class="snapper_nextprev_prev"><i class="fa fa-chevron-left fa-4x"></i></a></li><li class="snapper_nextprev_item"><a href="#next" class="snapper_nextprev_next"><i class="fa fa-chevron-right fa-4x"></i></a></li></ul>' );
			if( addNextPrev ){
